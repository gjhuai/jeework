 ...
 * @author Chris Guan
 */
public class ExceptionKeyMessage implements ExceptionMessage, Serializable
{
    ...
    */
   public <E extends Enum<?>> ExceptionKeyMessage(E key, Object... args)
   {
      this.messageKey = key;
   ...
   public String getAsString()
   {
      ...
      try
      {
    	  result = messageConveyerFactory().getDefaultMessageConveyer().getMessage(messageKey, (Object[]) messageArguments);
