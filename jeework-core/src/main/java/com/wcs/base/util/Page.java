...
public class Page<T> {
	...
	protected Long totalCount = Long.valueOf(-1);
	...
	public Page(final List<T> result, Long totalCount, Long first, int pageSize) {
	...
	public Long getFirst() {
		...
		return ( (Integer)( ((pageNo - 1) * pageSize) + 1) ).longValue()  ;
	}
